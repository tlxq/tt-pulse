...
export default function Dashboard() {
  ...
  return (
    <main className="min-h-screen p-6 md:p-12 max-w-7xl mx-auto space-y-10 bg-[#020617] text-slate-200 font-sans">
      {/* Global Header */}
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="bg-[#0f172a]/40 border border-slate-800/60 rounded-3xl p-8 relative overflow-hidden group shadow-[0_0_15px_rgba(59,130,246,0.05)] transition-all hover:shadow-[0_0_20px_rgba(59,130,246,0.1)]">
          <div className="relative z-10 space-y-4">
            ...
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-blue-500 font-bold text-sm italic">
                24h
              </span>
            </div>
          </div>
        ...
        <div className="bg-[#0f172a]/40 border border-slate-800/60 rounded-3xl p-8 relative overflow-hidden group shadow-[0_0_15px_rgba(59,130,246,0.05)] transition-all hover:shadow-[0_0_20px_rgba(59,130,246,0.1)]">
          <div className="relative z-10 space-y-4">
            ...
            <div className="flex items-baseline gap-2">
              ...
              <span className="text-yellow-500 font-bold text-sm italic">
                Score
              </span>
            </div>
          </div>
