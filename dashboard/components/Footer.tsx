...
export function Footer() {
  return (
    <footer className="w-full py-12 mt-20 border-t border-slate-800/40">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8 px-6">
        ...
        <div className="flex flex-col items-center md:items-start gap-2">
          <div className="flex items-center gap-2 text-slate-400 font-black uppercase tracking-[0.3em] text-[10px]">
            Forged in the <span className="text-amber-500">Bengal Territory</span>
          </div>
        ...
        <div className="flex items-center gap-10">
          ...
          >
            <Terminal className="w-4 h-4 text-slate-500 group-hover:text-amber-500 transition-colors" />
          ...
          <a 
            ...
            target="_blank" 
            rel="noopener noreferrer"
            className="group flex items-center gap-2.5 px-4 py-2 bg-amber-500/5 border border-amber-500/10 rounded-xl hover:bg-amber-500/10 hover:border-amber-500/30 transition-all active:scale-95"
          >
            <Globe className="w-3.5 h-3.5 text-amber-500" />
            <span className="text-[10px] font-black uppercase tracking-widest text-amber-500">ttdevs.com</span>
          </a>
        </div>
      </div>
